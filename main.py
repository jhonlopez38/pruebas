...
#  Despliega en Render.com como Web Service Python
...
# ⚠️ Cambia esta URL por la tuya cuando Render te la asigne
...
# Servir archivos estáticos de la web app
app.mount("/static", StaticFiles(directory=STATIC_FOLDER), name="static")
# Servir archivos generados (CSV, KML)
...
# ------------------------------------------------------------------
# Recibir archivos del ESP32 (CSV, KML)
# ESP32 hace: POST /upload/gps_log.csv  con el cuerpo binario
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Comandos: la web app escribe, el ESP32 lee al despertar
# ------------------------------------------------------------------
@app.post("/command")
...
# ------------------------------------------------------------------
# Estado del dispositivo: el ESP32 escribe, la web app lee
# ------------------------------------------------------------------
